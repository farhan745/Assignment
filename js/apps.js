...
function customizationPrice(id, cost) {
  ...
  document.getElementById("user-payment").innerText = totalPrice.textContent;
}
// function promocode()
function promocode() {
  const promocodeInput = document.getElementById("input-field");
  const promocode = promocodeInput.value;
  if (promocode === "javascript123") {
    const totalCost = updateTotal();
    const totalPrice = document.getElementById("total-price");
    totalPrice.textContent = totalCost - totalCost * 0.1;
    document.getElementById("user-payment").innerText = totalPrice.textContent;
  }
}
function pink(){
  document.getElementById('image1').src='images/macPink.jpg';
}
function blue(){
  document.getElementById('image1').src='images/macBlue.jpg';
}
function white(){
  document.getElementById('image1').src='images/mac.png';
}
